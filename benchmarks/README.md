...
| 4 | GPU **parsimony** 2D-grid Fitch, bit-identical: AA-1M GPU 56.59 s, **3.76×** vs best-CPU (IQ-parsimony) — *never "71×" (PLL artifact)* | 172524833 / 172526962 | [parsimony/](parsimony/) | `scratch-survivors/fig4-parsimony/` | ✅ GPU 56.591 s; `VERIFY mismatches=0` (AA+DNA); ⚠ CPU 212.7 s baseline line to re-anchor |

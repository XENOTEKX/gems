...
| — | **Reopt-depth Pareto**: shipped `JOLT_BRLEN_MAXITER` floor **m=2** is a Pareto knee — same MLE for m≥2 (\|ΔlnL\|≤0.004 nat; 3 seeds at 10⁵, 1 seed at DNA-1M), 1.24–2.43× vs m=12 *within-GPU, not vs CPU*; DNA-1M **m=1 collapses −3139.83 nats and is slower** | 172882999 / 172883000 / 172883001 | [reopt/](reopt/) | `reproductions/reopt_pareto_{AA_100000_172882999,DNA_100000_172883000,DNA_1000000_172883001}.gadi-pbs/` | ✅ lnL-identity (RF column is a parse bug — ignored) |

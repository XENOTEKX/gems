...
public:
	...
	*/
	...
	/** GPU free-Q joint optimiser — see ModelSubst. Pack model free params -> out[0..getNDim()-1]. */
	virtual void gpuGetFreeParams(double *out);
	/** GPU free-Q joint optimiser — see ModelSubst. in[0..getNDim()-1] -> model rates, then decomposeRateMatrix(). */

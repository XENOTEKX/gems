...
public:
	...
	*/
	...
	/**
		GPU free-Q JOLT: pack the free model parameters (exchangeabilities + estimated freqs)
	...
	*/
	...
	/**
		GPU free-Q JOLT: write the free model parameters from a flat 0-indexed vector of length

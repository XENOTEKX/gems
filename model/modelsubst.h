...
public:
	...
	*/
	...
	/**
		GPU free-Q joint optimiser: pack the free model parameters (exchangeabilities + estimated freqs)
		...
		ModelMarkov overrides. Called ONLY under --gpu/--gpu-joint -> the CPU path never invokes these.
	*/
	virtual void gpuGetFreeParams(double *out) {}
	/**
		GPU free-Q joint optimiser: write the free model parameters from a flat 0-indexed vector of length
